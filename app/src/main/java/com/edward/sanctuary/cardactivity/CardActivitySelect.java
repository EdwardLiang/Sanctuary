...
public abstract class CardActivitySelect extends CardActivity {
    protected androidx.appcompat.view.ActionMode am;
    ...
    public void setActionBarSelecting(boolean selecting){
        if(selecting){
            ...
            am = startSupportActionMode((androidx.appcompat.view.ActionMode.Callback) new ActionBarSelect());
        }
        else{
            if(am != null){
                am.finish();
    ...
    public void confirmDeleteDialog(){
        ...
        if(Session.getInstance(this).darkModeSet()) {
            con = new ContextThemeWrapper(this, androidx.constraintlayout.widget.R.style.Theme_AppCompat_Dialog_Alert);
