    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey("Card")) {
            ...
            if (Build.VERSION.SDK_INT < 23) {
                ...
                editTitle.setTextAppearance(getActivity(), com.google.android.material.R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
            } else {
                //editTitle.setTextAppearance(R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
                editTitle.setTextAppearance(com.google.android.material.R.style.TextAppearance_Design_CollapsingToolbar_Expanded);
            }
